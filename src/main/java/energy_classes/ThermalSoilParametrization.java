...
public abstract class ThermalSoilParametrization {
	...
	public ThermalSoilParametrization(double thetaS, double sandFraction, double clayFraction, SoilParametrization soilPar){
		this.thetaS = thetaS;
	...
	public static void main(String[] args) {
		...
		ThermalSoilParametrization thermalPar;
		SimpleThermalSoilParametrizationFactory thermalParFactory = new SimpleThermalSoilParametrizationFactory();
		thermalPar = thermalParFactory.createThermalSoilParametrization(thermalModel, thetaS, 0.35, 0.4,
				soilPar, 2700*(1-thetaS), "mineral soil", 2.5, 0.5);

...
public class PrintTXT {
	...
	public void PrintOneVector(String name, String header, String variable){
		this.name = name;
		this.header = header;
	...
	public void PrintTwoVectors(String name, String header, String variable){
		this.name = name;
		this.header = header;
		this.variable = variable;
	...
	public void PrintThreeVectors(String name, String header, String variable){
		this.name = name;
		this.header = header;
		this.variable = variable;
